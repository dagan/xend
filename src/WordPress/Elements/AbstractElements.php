...
abstract class AbstractElements implements ElementsInterface {
    ...
    public function initWidgets() {
        ...
        if ($this->_initWidgetsDone) {
            throw new Exception("The initWidgets method has already been invoked. Do not invoke this method directly. "
                . "It is invoked by the WordPress widgets_init action.");
        }
        ...
        foreach ($this->_sidebars as $sidebar) {
            ...
            if (!function_exists("register_sidebar")) {
                throw new Exception("Native WordPress function register_sidebar is not defined");
            }
    ...
    public function registerMenuLocations(array $locations) {
        if (!function_exists('register_nav_menus')) {
            throw new Exception("Native WordPress function register_nav_menus() is not defined");
        }
